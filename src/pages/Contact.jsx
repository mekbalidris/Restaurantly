export default function Contact() {
  return (
    <div id="contact" className="bg-secondbg py-16 px-4 sm:px-6">
      ...
      {/* Contact Info & Form */}
      <div className="flex flex-col lg:flex-row justify-between items-start max-w-5xl mx-auto mt-12 gap-10 px-4 sm:px-0">
        {/* Contact Info */}
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                className="p-3 bg-transparent border border-golden rounded-lg w-full"
              />
              <input
                type="email"
            ...
            <button
              type="submit"
              className="bg-golden text-black py-2 px-6 rounded-lg hover:opacity-80 transition"
            >
              Send Message
            </button>
          </form>
